...
\begin{empheq}[left=\empheqbiglbrace]{align}
    &u\in C\left([0,T],C_0(\Omega)\right)\cap C\left((0,T], H_0^1(\Omega)\right)\cap C^1\left((0,T], L^2(\Omega)\right);\refstepcounter{equation}\tag{\theequation a}\label[equation]{classforsemilinearheat}\\
