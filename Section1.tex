...
\end{equation*}
\footnotetext{$\beta=(\beta_1,\beta_2,...,\beta_d) \in \mathbb{N}_0^d$ bo`lsa $x^\beta=x_1^{\beta_1}\cdots  x_d^{\beta_d}$ va $\partial^\beta=\frac{\partial^{\beta_1+\beta_2+...+\beta_d}}{\partial_{x_1}^{\beta_1}\partial_{x_2}^{\beta_2}\cdots \partial_{x_d}^{\beta_d}}$}
